...
> **2026-09-21 최신 상태:** [PostgreSQL 가능 여부 점검](postgresql-readiness-2026-09-21/README.md)과 [v3·56개 전략 인수인계](handoff-v3-56-2026-09-21.md)를 먼저 읽는다. v3 공급은 확인했으며, 현재 남은 핵심은 vectorbt의 인수·REAL 실행·신규 8개 구현과 검증이다. 아래 48개 설계와 과거 차단 기록은 기존 v1의 이력이며 최신 실행 지시를 대체하지 않는다.
...
| [48개 후보와 실자료 실행 계획](strategy-catalog-and-real-data-plan-2026-09-18.md) | 현재 합성 검증의 범위와 실자료 차단을 풀기 위한 단계·책임은 무엇인가 |
| [독립 KRX 데이터 확보 가능성 감사](independent-krx-data-acquisition-plan-2026-09-19.md) | ted-startup과 별개로 수집할 공식 경로가 어느 수준까지 확인됐고 무엇이 아직 막혀 있는가 |
