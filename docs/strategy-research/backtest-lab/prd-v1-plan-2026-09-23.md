...
| 비용표 | 부분 | 실행 규칙 15행을 보유하고, 거래세를 원문으로 재확인해 2014년 공백과 체결일 경계를 고친 새 표를 만들었다(B2b). | 수수료는 사용자 가정(0.015%)이고, 농특세·호가·가격제한은 원문 미재확인이다. 새 표는 실행 경로에 연결하지 않았다. | [B2b 결과](prd-v1-data-2026-09-23/README.md#b2b-효력일별-비용표) |
...
| B2b | 비용표를 `rules.parquet` 형식의 효력일별 표로 반영하고 법령 원문으로 재확인한다. | 코드, 외부 원천 | B2 | 완료(거래세 원문 확인, 미연결), [결과](prd-v1-data-2026-09-23/README.md#b2b-효력일별-비용표) |
