# 현재 인수인계: 백테스트 완료, 다음 세션은 다른 전략 브레인스토밍
...
- 이번 보존 대상: 기존 연구 문서·WBS·감사 SQL/JSON/로그·전략 예시 그림과 최신 점검 보고서. 루트의 `.tmp_admin.html`, `.tmp_full_ksq.html`, `.tmp_full_stk.html`, `.tmp_ksq_kind.html`, `.tmp_stk_kind.html`은 조사 임시 파일로 로컬에 보존하며 커밋에서 제외한다.
